...
def test_criar_medicamento():
    med = Medicamento(1, "Dipirona", 500, "08:00", "segunda", 7, "Tomar 1 comprimido")
...
def test_dosagem_invalida():
    med = Medicamento(1, "Teste", 500, "08:00", "segunda", 7, "Teste")
...
def test_nome_vazio():
    med = Medicamento(1, "Remedio", 500, "08:00", "segunda", 7, "Teste")
